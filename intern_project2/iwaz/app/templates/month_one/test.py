...
wordcloud = WordCloud(font_path='font/H2GTRE.TTF', background_color='white',width=650,height=650,mask=dalong).generate(string_month_one)
...
def index(): # 여기에서 이미지를 만들어야한다.
        ...
        return render_template('/month_one/test.html' , p = news_one)